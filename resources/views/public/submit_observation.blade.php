                ...
                <form action="{{ route('public.observations.submit') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div style="border-top: 1px solid #eee; padding-top: 15px; margin-top: 5px;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.1" min="-10" max="60"
                                    id="temperature_celsius" name="temperature_celsius" placeholder="e.g. 24.5"
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.1" min="0" max="10"
                                    id="drought_index" name="drought_index" placeholder="e.g. 2.5 (0-10 scale)"
                                    class="form-control" style="height: 35px;" value="{{ old('drought_index') }}">
                            </div>
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.1" min="0" max="100"
                                    id="vegetation_cover_percent" name="vegetation_cover_percent"
                                    placeholder="e.g. 75.5" class="form-control" style="height: 35px;"
                            ...
                            <div class="form-group">
                                ...
                                <select id="vegetation_condition" name="vegetation_condition" class="form-control"
                                    ...
                                    <option value="Healthy"
                                        {{ old('vegetation_condition') === 'Healthy' ? 'selected' : '' }}>Healthy
                                    </option>
                    ...
                    <div
                        ...
                        <div class="form-group">
                            ...
                            <small style="color: #666; font-size: 11px; display: block; margin-top: 3px;">PNG, JPG,
                                JPEG up to 4MB</small>
                        </div>
                        <div class="form-group">
                    ...
                    <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                        <thead>
                            <tr style="border-bottom: 2px solid #dddddd; background: #f9f9f9; text-align: left;">
                                ...
                                <th style="padding: 10px; font-weight: bold; width: 80px; text-align: center;">Action
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse ($myObservations as $obs)
                                <tr style="border-bottom: 1px solid #eeeeee;">
                                    <td style="padding: 10px;">
                                        <strong
                                            style="color: #1e5631; display: block;">{{ $obs->flora_name }}</strong>
                                        <span style="font-size: 11px; color: #666;">{{ $obs->location }}</span>
                                        <div style="font-size: 11px; color: #888; margin-top: 3px;">Observed:
                                            {{ $obs->date_observed ? $obs->date_observed->format('Y-m-d') : 'N/A' }}
                                        </div>
                                    </td>
                                    <td style="padding: 10px; vertical-align: middle;">
                                        <span
                                            style="font-weight: bold; padding: 2px 6px; border-radius: 4px; font-size: 10px; display: inline-block;
                                    ...
                                    <td style="padding: 10px; text-align: center; vertical-align: middle;">
                                        <form action="{{ route('public.observations.delete', $obs->observation_id) }}"
                                            method="POST"
                                            onsubmit="return confirm('Are you sure you want to delete this observation report?');">
                                            @csrf
                                            <button type="submit"
                                                style="background: #a94442; color: white; border: none; padding: 5px 10px; border-radius: 4px; font-size: 11px; font-weight: bold; cursor: pointer;">Delete</button>
                                        </form>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="3" style="padding: 20px; text-align: center; color: #666;">You
                                        haven't submitted any observation reports yet.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
