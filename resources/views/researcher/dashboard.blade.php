                            ...
                            @forelse($observations as $obs)
                                <tr class="obs-row" data-status="{{ $obs->status }}" data-level="{{ $obs->flora ? $obs->flora->vulnerability_level : 'Not Assessed' }}">
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        <a href="{{ route('researcher.observations.review.show', $obs->observation_id) }}"
                                            class="btn-action"
                                            style="background: #f4f6f4; border: 1px solid #c8d2c8; color: #1e5631; padding: 4px 8px; font-size: 10px; width: 100%; text-align: center; margin-top: 5px; box-sizing: border-box; text-decoration: none; display: block;">View
                                            Full Details & CSV</a>
                                    </td>
                                </tr>
                            @empty
